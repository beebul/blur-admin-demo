...
(function () {
  ...
  angular.module('BlurAdmin.pages.dashboard')
      .controller('dashboardPieAskCCCtrl', dashboardPieAskCCCtrl);

  /** @ngInject */
  function dashboardPieAskCCCtrl($scope, $timeout, baConfig, baUtil) {
    var pieColor = baUtil.hexToRGB(baConfig.colors.defaultText, 0.2);
    $scope.charts = [{
      color: pieColor,
      description: '11111111111Recognition and Engagement',
      stats: '93%',
      icon: 'person',
      percentage: '93',
